...
const int POST_PASSESS = 20;

Renderer::Renderer(Window& parent) : OGLRenderer(parent) 
{
	camera = new Camera(-25.0f, 225.0f, Vector3(-150.0f, 250.0f, -150.f));
